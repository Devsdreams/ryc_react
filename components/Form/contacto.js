...
export default function Form() {
  ...
  return (
    <div>
      {" "}
      <ChakraProvider theme={theme} className="xs:mt-16">
        <Container className="xs:mt-16 sm:mt-16">
          <Heading className="mb-5 mt-5 text-xs sm:mt-10 xs:mt-16">CONTÁCTANOS</Heading>
          {error && (
